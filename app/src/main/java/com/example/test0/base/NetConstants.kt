...
//        const val OnlineWorkBase =  "http://192.168.10.104:8080/zhjd/onlinework.html?id="
        ...
        //查询天气接口
        const val WeatherUrl ="https://tianqiapi.com/api?version=v6&appid=52796525&appsecret=2cBrl3hs&city=金水"
        //七日天气接口
        const val WeatherDaysUrl ="https://tianqiapi.com/api?version=v1&appid=52796525&appsecret=2cBrl3hs&city=金水"
        //实时疫情接口
